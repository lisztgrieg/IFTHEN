...
These should be carried forward until resolved, removed, or the user asks to stop showing them. If the user says "anr", add new reminders. Renumber the current reminder list only and ignore past resolved reminder numbers.
